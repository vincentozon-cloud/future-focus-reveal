            ...
            >
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-yellow-400 hover:text-[#1B4332] transition-colors active:scale-95"
                >
